...
public final class ActivityBattleEndBinding implements ViewBinding {
  @NonNull
  ...
  private ActivityBattleEndBinding(@NonNull LinearLayout rootView, @NonNull ImageButton closeBtn,
      @NonNull FragmentContainerView mapFragmentContainer, @NonNull TextView result,
      @NonNull TextView title, @NonNull TextView todayDistance, @NonNull TextView todayTime) {
  ...
  @NonNull
  public static ActivityBattleEndBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ActivityBattleEndBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.activity_battle_end, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ActivityBattleEndBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityBattleEndBinding((LinearLayout) rootView, closeBtn, mapFragmentContainer,
          result, title, todayDistance, todayTime);
    }
