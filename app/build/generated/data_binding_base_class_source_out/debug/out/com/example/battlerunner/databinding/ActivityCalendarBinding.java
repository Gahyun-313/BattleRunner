...
public final class ActivityCalendarBinding implements ViewBinding {
  ...
  private ActivityCalendarBinding(@NonNull LinearLayoutCompat rootView,
      @NonNull MaterialCalendarView calendarView, @NonNull ImageButton closeBtn) {
  ...
  public static ActivityCalendarBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityCalendarBinding((LinearLayoutCompat) rootView, calendarView, closeBtn);
    }
